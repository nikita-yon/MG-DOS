...
def list_directory(path="."):
    ...
    print("{:<19} {:<15} {:<12} {:>20} {}".format("Дата", "Время", "Тип", "Размер", "Имя Файла"))
    print("=" * 80)
...
def openn1():
    print(f"Версия MG-DOS {MGDOSVER}")
    print("(c) Студия Mistikal Green (Корпорация MG Electron). Все права защищены.")
    print("Введите 'help' для получения дополнительных команд.")
    print()
...
def allcommand():
    ...
    def wiltru():
        ...
        while True:
            ...
            if word == "help":
                print("Для проверки конкретной команды введите HELP <имя команды>")
                print("write [имя файла] '[содержание]'        запись в текстовый файл")
                print("clear, cls                            очистить консоль")
                print("reboot                                перезапустить MG-DOS")
                print("cipher                                шифрование и дешифрование текста")
                print("calc                                  калькулятор")
                print("compare                               сравнение двух чисел")
                print("listen [имя_файла.расширение]         прослушивание аудиофайла")
                print("sort [расширение]                     количество файлов с заданным расширением")
                print("read [имя_файла.расширение]           чтение файла")
                print("open                                  открыть 'папку' из директории")
                print("tree [папка]                          структура файловой системы")
                print("dir  [папка]                          просмотр каталогов")
                print("dirc                                  текущий каталог (компьютера)")
                print("volume                                показать список доступных устройств")
                print("rename [старое_имя] '[новое_имя]'     переименовать файл или папку")
                print("mkdir [имя_папки]                     создать папку")
                print("mktxt [имя_файла.расширение]          создать файл с указанным расширением")
                print("run [имя_файла.расширение]            запустить исполняемый файл")
                print("delete [любые_файлы]                  удалить любой тип файлов")
                print("cd [папка]                            сменить директорию")
                print("pause                                 приостановить MG-DOS")
                print("exit                                  выход из MG-DOS")
                print("save                                  сохранить историю команд MG-DOS")
            ...
            try:    
                ...
                if match := re.match(regex, word):
                    xtx = match.groups()[0]
                    if xtx == "help":
                        print("Использование: help [команда] 'показать информацию о команде'")
                    if xtx == "write":
                        print("Использование: write [имя_файла.расширение] '[содержание]' 'запись в файл; ПРЕДУПРЕЖДЕНИЕ: содержание в кавычках;'")
                    if xtx == "clear":
                        print("Использование: clear или cls 'очистить консоль'")
                    if xtx == "reboot":
                        print("Использование: reboot 'перезапустить MG-DOS'")
                    if xtx == "cipher":
                        print("Использование: cipher 'шифрование / дешифрование любого текста или сообщения'")
                    if xtx == "calc":
                        print("Использование: calc 'калькулятор для вычисления чисел (1 + 1 = 2)'")
                    if xtx == "campare":
                        print("Использование: compare 'сравнение чисел (1 < 2)'")
                    if xtx == "listen":
                        print("Использование: listen [имя_файла.расширение] 'прослушивание аудиофайлов, таких как mp3, wav'")
                    if xtx == "sort":
                        print("Использование: sort [расширение] 'просмотр количества файлов с расширением [расширение]'")
                    if xtx == "read":
                        print("Использование: read [имя_файла.расширение] 'чтение файлов, таких как txt, py'")
                    if xtx == "tree":
                        print("Использование: tree [папка] 'построение древа файловой системы'")
                    if xtx == "dir":
                        print("Использование: dir [папка] 'просмотр директорий'")
                    if xtx == "dirc":
                        print("Использование: dirc 'просмотр текущей папки'")
                    if xtx == "mkdir":
                        print("Использование: mkdir [имя_папки] 'создание папки'")
                    if xtx == "mktxt":
                        print("Использование: mktxt [имя_файла.расширение] 'создание текстового файла, например, txt, py'")
                    if xtx == "run":
                        print("Использование: run [имя_файла.расширение] 'запуск скриптовых файлов, например, py, html, svelte'")
                    if xtx == "delete":
                        print("Использование: delete [имя_файла] 'удаление файла любого типа'")
                    if xtx == "cd":
                        print("Использование: cd [папка] 'сменить текущую папку'")
                    if xtx == "pause":
                        print("Использование: pause 'приостановить все процессы'")
                    if xtx == "rename":
                        print("Использование: rename [старое_имя] '[новое_имя]' 'переименование файла или папки; ПРЕДУПРЕЖДЕНИЕ: новое имя в кавычках;'")
                    if xtx == "volume":
                        print("Использование: volume 'показать список доступных устройств, таких как - диски, USB, SSD, CD-ROM, DVD, жесткие диски'")
            except:
            ...
            if word == "reboot":
                print("вы уверены что хотите перезагрузить MG-DOS?")
                asd = input("Нет[N] или Да[Y]>")
                if asd == "y":
            ...
            if word == "calc":
                        try:
                            ...
                            print("Ошибка: некоректная операция или число")
            ...
            if word == "compare":
                try:
                    ...
                    number11 = float(input('первое число: '))
                    number22 = float(input('второе число: '))
            ...
            try:    
                ...
                print(f"файл '{file3}' не найден")
            except subprocess.CalledProcessError:
                print(f"Произошла ошибка при запуске '{file3}'")
            try:    
                regex = "cd ([\s\S]+)"
                if match := re.match(regex, word):
                ...
                print("директория " + file31 + " не найдена")
            ...
            try:    
                ...
                print("Ошибка: файл '" + file3 + "' не найден")
            except Exception:
                 print("Ошибка: что-то пошло не так")
            #if word == "opengame":
          #      def openpy():
           ...
           # if word == "read":
            try:
                ...
                if match := re.match(regex, word):
                    ...
                    print("Ошибка: файл '"+file+"' не найден")
            
            except Exception:
                    print("Ошибка: невозможно прочитать '"+file+"'")
            ...
            try:
                ...
                if match := re.match(regex, word):
                    ...
                    print(f"файл '{filename}' успешно переименован в '{newname}'")   
            except FileNotFoundError:
            ...
            try:
                ...
                if match := re.match(regex, word):
                    ...
                    print("Ошибка: директория '"+asd23+"' не найдена")    
            except Exception:
                    print("Ошибка: что-то пошло не так")         
            ...
            def write_history_to_log(history, log_file):
                ...
                print(f"создаём LOG.txt {log_file}...")
            ...
            try:
                ...
                if match := re.match(regex, word):
                    dr12 = match.groups()[0]
                    print("Вы уверены что хотите удалить '"+dr12+"'")
                    asd = input("No[N] or Yes[Y]>")
                    if asd == "y":
                        os.remove(dr12)
     
            except FileNotFoundError:
                    print("Ошибка: файл '"+dr12+"' не найден")
            except Exception:
                    print("Ошибка: что-то пошло не так")
            ...
            try:
                ...
                if match := re.match(regex, word):
                    dr1 = match.groups()[0]
                    open(dr1, 'x')
                    print("файл '"+dr1+"' успешно создан!")

            except FileExistsError:
                    print("Ошибка: файл '"+dr1+"' уже существует")
            except Exception:
                    print("Ошибка: что-то пошло не так")
            ...
            try:
                ...
                if match := re.match(regex, word):
                    dr = match.groups()[0]
                    os.system("mkdir " + dr)
                    print("папка с именем '"+dr+"' создана успешно!")
            except FileExistsError:
                    print("Ошибка: папка с именем '"+dr+"' уже сушествует")
            except Exception:
                    print("Ошибка: что-то пошло не так")
            if word == "pause":
                press_any_key()
            ...
            if word == "save":
                atexit.register(write_history_to_log, history, "log.txt")
                print("история MG-DOS успешно записана в log.txt")
